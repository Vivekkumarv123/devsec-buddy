...
⚠️ **Note**: The backend is hosted on Render’s free tier, so the first request may take 20–50 seconds due to cold start. Please be patient — it’s waking up the security minions! 🛠️⏳
